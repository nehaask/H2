...
public class ErrorCode {
    ...
    */
    ...
    /**
     * DBSI-621 Assignment 2
     * The error with code <code>90158</code> is thrown when
     * the email address entered do not match the required regex.
     */
    public static final int INVALID_EMAIL = 90158;

    // DBSI CODE HERE
    /**
     * DBSI-621 Assignment 3
     * The error with code <code>90159</code> is thrown when
     * invalid parameters are passed in the AggregateDataRange function.
     * Should be passed as (INT, INT)
     */
    public static final int INVALID_ARGUMENTS_PASSED = 90159;
